...
<!-- MAP:BEGIN -->
> Workspace tier · drift-checked in `mise run fleet:check` · details live in each component's README

| Path | What lives here |
|---|---|
| [`crates/`](crates/) | Rust workspace members |
| [`crates/pg_query_fmt/`](crates/pg_query_fmt/) | PostgreSQL SQL formatter powered by pg_query |
| [`crates/schemalane-cli/`](crates/schemalane-cli/) | CLI for Schemalane PostgreSQL-first, forward-only migrations |
| [`crates/schemalane-core/`](crates/schemalane-core/) | Core migration engine for Schemalane PostgreSQL-first, forward-only migrations |
| [`crates/schemalane-embed-tests/`](crates/schemalane-embed-tests/) | This fixture tests sanitized-name collisions and uppercase `.RS`. |
| [`crates/schemalane-macros/`](crates/schemalane-macros/) | Procedural macros for Schemalane migration embedding |
| [`crates/schemalane-version/`](crates/schemalane-version/) | Flyway-compatible version and migration filename parsing for Schemalane |
| [`docs/`](docs/) | Research and supporting documentation |
| [`plans/`](plans/) | Completed direction-spike decision records |
| [`scripts/`](scripts/) | Repository verification scripts |
<!-- MAP:END -->
...
```sh
# from workspace root
cargo install --path crates/schemalane-cli --force
