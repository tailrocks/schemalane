...
<!-- MAP:BEGIN — generated by `mise run fleet:map`; edit [map.dirs], not the block -->
> Drift-checked in `mise run fleet:check` · details live in each component's README
| [`crates/`](crates/) | Rust workspace members |
| [`crates/schemalane-core/`](crates/schemalane-core/) | Migration discovery, state, history, locking, execution |
| [`crates/schemalane-cli/`](crates/schemalane-cli/) | CLI grammar, rendering, TLS, migration-crate delegation |
| [`crates/pg_query_fmt/`](crates/pg_query_fmt/) | PostgreSQL AST formatter, preview, highlighting |
| [`crates/schemalane-macros/`](crates/schemalane-macros/) | `embed_migrations!` proc macro |
| [`crates/schemalane-version/`](crates/schemalane-version/) | Shared Flyway-compatible filename/version parser |
| [`crates/schemalane-embed-tests/`](crates/schemalane-embed-tests/) | Unpublished compile-time fixture crate |
